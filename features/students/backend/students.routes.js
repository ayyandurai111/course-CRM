...
const { z } = require("zod");
const { supabase, row, rows, assertNoError } = require("../../../shared/backend-core/db");
const { authenticate, requireAdmin } = require("../../auth/backend/auth.middleware");
const { logAction } = require("../../audit/backend/auditService");
const { getCurrentSubscriptionsByUserIds } = require("../../plans-subscription/backend/subscriptionService");
const { beginStudentDeletion } = require("../../storage-upload/backend/userDeletionService");
const { containsPattern } = require("../../../shared/backend-core/searchFilter");
const { parseValidDate } = require("../../../shared/backend-core/dateValidation");
