...
import type { Course, SiteContent } from "../../../../shared/frontend-core/types/index";
import { ErrorState, EmptyState } from "../../../../shared/frontend-core/components/common/States";
import { CardGridSkeleton } from "../../../../shared/frontend-core/components/common/Skeleton";
...
export default function CourseShowcase({ content }: { content: SiteContent["courseShowcase"] }) {
  ...
  return (
    <section id="courses" className="scroll-mt-24 mx-auto max-w-6xl px-5 py-20">
