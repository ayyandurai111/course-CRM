...
import type { QuizAnswerReview, QuizAttempt } from "../../../../shared/frontend-core/types/index";
import { LoadingState, ErrorState, EmptyState } from "../../../../shared/frontend-core/components/common/States";
import Modal from "../../../../shared/frontend-core/components/modals/Modal";
import { ArrowLeftIcon } from "../../../../shared/frontend-core/components/common/Icons";
            ...
            <tbody className="divide-y divide-ink-900/8">
              {attempts.map((a) => (
                <tr key={a.id} className="cursor-pointer hover:bg-ink-100/40" onClick={() => setViewingAttemptId(a.id)}>
                  ...
                  <td className="px-5 py-3 text-ink-500">{a.completedAt ? formatIst(a.completedAt) : "—"}</td>
                </tr>
              ))}
            </tbody>
          </table>
