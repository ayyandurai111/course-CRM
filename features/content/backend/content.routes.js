...
const { deleteFileSafely } = require("../../storage-upload/backend/storage.lib");
const { authenticate, requireAdmin } = require("../../auth/backend/auth.middleware");
const { getAccessibleCourseIds, userCanAccessContent } = require("../../plans-subscription/backend/accessService");
const contentService = require("./contentService");
const { logAction } = require("../../audit/backend/auditService");
const { isSafeId, isValidContentFileKey } = require("../../storage-upload/backend/fileValidation.lib");
const { containsPattern } = require("../../../shared/backend-core/searchFilter");
const { futureIsoDateTimeString } = require("../../../shared/backend-core/dateValidation");
