...
import { istInputValueToIso, nowAsIstInputValue, formatIst } from "../../../../shared/frontend-core/lib/istTime";
import type { ContentItem, Course, Meeting, MeetingRecordingSegment } from "../../../../shared/frontend-core/types/index";
          ...
          <div className="space-y-3 sm:hidden">
            {meetings.map((m) => (
              <div key={m.id} className="rounded-xl2 border border-ink-900/8 bg-white p-4 shadow-card">
                ...
                <p className="mt-1 text-xs font-medium text-ink-600">{formatIst(m.scheduledAt)}</p>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-ink-900/8">
                {meetings.map((m) => <Fragment key={m.id}><tr>
                  ...
                  <td className="px-5 py-3 text-ink-500">{formatIst(m.scheduledAt)}</td>
